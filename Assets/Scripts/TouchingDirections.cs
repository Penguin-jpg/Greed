...
public class TouchingDirections : MonoBehaviour
{
    ...
    private Vector2 wallCheckingDirection => gameObject.transform.localScale.x > 0 ? Vector2.right : Vector2.left;
...
[SerializeField]
    ...
    private void FixedUpdate()
    {
        ...
        IsOnWall = touchingCollider.Cast(wallCheckingDirection, castFilter, wallHits, wallDistance) > 0;
